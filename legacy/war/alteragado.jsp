	...
	<div id="content-wrap"><div id="content">		
		...
		<!-- barrinha do lado na parte de cima pequininho -->
			...
			<div class="sidebox">			
				...
				<ul class="sidemenu">
					<li><a href="visualizagado.jsp">Voltar</a></li>								
				</ul>				
			</div>																			
		</div>	
					...
					<%
						/* conexao com o banco */
						Key id = KeyFactory.stringToKey(request.getParameter("idGado"));
						EntityManager em = EMF.get().createEntityManager();
						Gado varGado = em.find(Gado.class, id);
					%>
...
<div id="main">				
	<div class="post">
		...
		<h1>Alterar Ra&ccedil;a de Gado</h1>
				
		<ul>	
		<p>A primeira letra Mai&uacute;scula</p>																											
			<form id="milho" action="../ServletGado" method="get">
			<input type="hidden" name="acao" value="Atualizar"/>
			<input type="hidden" name="idGado" value="<%= KeyFactory.keyToString(varGado.getId())%>" />
				<table>
					<tr>
						<th class="first"><strong>Ra&ccedil;a de Gado</strong></th>
						<th><p class="buttonConf"><input title="Salvar" type="submit" name="enviar" value="" title=""/></p></th>
						
									
					</tr>
					<tr class="row-a">
						<td class="first"><input required type="text" size="20" maxlength="20" name="racaGado" value="<%=varGado.getNomeGado()%>"/></td>
						<td></td>
					</tr>
				</table>
			</form>					
