			...
			<div class="sidebox">			
				...
				<ul class="sidemenu">
					...
					<%
						...
						Query qRacao = em.createQuery("SELECT o FROM Racao AS o WHERE o.status = 'V'");
...
<div id="main">				
	<div class="post">
		...
		<h1>Ra&ccedil;&atilde;o para venda</h1>
				
		<ul>	
		<p>Lista de todas as ra&ccedil;&otilde;es cadastradas para venda</p>
		<p>Clique sobre a ra&ccedil;&atilde;o para visualiz&aacute;-la</p>																																																					
			<table>
							<tr>
								<th class="first"><strong>Nome item</strong></th>
								<th style="width: 55px;"><p class="buttonSalva" ><a title="Cadastrar" href="cadastroracao.jsp"></a></p></th>
							</tr>
								<%
									int a = 0;
								...
								%>
									<tr class="row-<%=(a % 2 == 0) ? "a" : "b" %>">
										<td class="first" onclick="location.href='racaocadastradavenda.jsp?idRacao=<%=KeyFactory.keyToString(chamaRacao.getId()) %>'"><%=chamaRacao.getNomeRacao()%></td>
