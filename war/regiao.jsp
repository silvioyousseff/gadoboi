...
<title>Cadastro Regi&atilde;o</title>
</head>
<body>
...
<div id="main">				
	<div class="post">
		...
		<h1>Cadastro Regi&atilde;o</h1>
																																	
			<ul>			
			<p>A primeira letra Mai&uacute;scula</p>																											
			<form id="regiao" action="../ServletRegiao" method="get">
			<input type="hidden" name="acao" value="Inserir">
				<table>
					<tr>
						<th class="first"><strong>Nome da Regi&atilde;o</strong></th>
						<th><p class="buttonConf"><input type="submit" name="enviar" value="" title="Cadastrar" /></p></th>			
					</tr>
					<tr class="row-a">
						<td class="first"><input required type="text" size="20" maxlength="20" name="nomeRegiao" /></td>
						<td></td>
					</tr>
				</table>
			</form>					
