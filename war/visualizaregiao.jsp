			...
			<div class="sidebox">			
				...
				<ul class="sidemenu">
					...
					<%
						...
						List<Regiao> varRegiao = qRegiao.getResultList();
					%>
...
<div id="main">				
	<div class="post">
		...
		<ul>	
		<p>Lista de todas as regi&otilde;es cadastradas</p>																											
			<form id="milho" action="../ServletRegiao" method="get">																											
			<table>
							<tr>
								<th class="first"><strong>Nome item</strong></th>
								<th><p class="buttonSalva"><a title="Cadastrar" href="regiao.jsp"></a></p></th>
							</tr>
								<%
									int a = 0;
									for (Regiao chamaRegiao : varRegiao) {
								%>
									<tr class="row-<%=(a % 2 == 0) ? "a" : "b" %>">
										<td class="first"><%=chamaRegiao.getNomeRegiao()%></td>
										<td></td>
										<td><p class="buttonAlt"><a title="Alterar" href="alteraregiao.jsp?idRegiao=<%=KeyFactory.keyToString(chamaRegiao.getId()) %>"></a></p></td>
										<td><p class="buttonDel"><a title="Apagar" href="../ServletRegiao?acao=Remover&idRegiao=<%= KeyFactory.keyToString(chamaRegiao.getId())%>"></a></p></td>
									</tr>
								<%
										a++;
									}
