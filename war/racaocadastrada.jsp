...
<div id="main">				
	<div class="post">
		...
		<ul>			
		<!--  <form id="cadastroRacaoVenda" action="../ServletVendaRacao" method="get">
				...
				<code>
					...
					<br />
					<br />		
					Taxa de Rendimento em Kg: <input type="text" readonly="readonly"  name="taxaRendimento" maxlength="15" style="float: right;  width: 150px; text-align: right;"  value="<%=varRacao.getTaxaRendimento()%>" /> 
					<br />
					<br />		
				...
				<table style="float: left;">
				  ...
				  <% for(Metodo varMetodo: listaMetodo) { %>
					<tr class="row-b-metodo">
					
						<td class="first"><input readonly="readonly" type="text" size="10" maxlength="10" style="width: 350px;"  
			...
			<br />
				<table>
					...
					<% for(RacaoInsumo varInsumo: listaInsumo) { %>
					<tr class="row-b">
							<td class="first">
								<input readonly="readonly" type="text" size="10" maxlength="10" style="width: 150px;" value="<% 
									Insumo insumo = em.find(Insumo.class, varInsumo.getInsumo()); varInsumo.getId();
									out.print(insumo.getNomeInsumo());
						%>"/></td>
							<td><input readonly="readonly" type="text" size="10" maxlength="10" style="float: right; text-align: right;" value="<%=varInsumo.getQtdInsumo()%>"/></td>	
						</tr>
					<% } %>
				</table>
				<!--<input type="submit" title="Cadastrar para Venda" name="botao" value=""/> -->
			</form>		
		</ul>												
