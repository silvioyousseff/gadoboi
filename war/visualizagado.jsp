							...
							<tr>
								...
								%>
									<tr class="row-<%=(a % 2 == 0) ? "a" : "b" %>">
										...
										<td></td>
										<td><p class="buttonAlt"><a title="Alterar" href="alteragado.jsp?idGado=<%=KeyFactory.keyToString(chamaGado.getId()) %>" title="Alterar"></a></p></td>
										<td><p class="buttonDel"><a title="Apagar" href="../ServletGado?acao=Remover&idGado=<%= KeyFactory.keyToString(chamaGado.getId())%>" title="Apagar"></a></p></td>
									</tr>
								<%
										a++;
									}
